...
class Scenario(BaseScenario):
	...
	def observation(self, agent:Agent, world:World) -> arr:
		"""
			Return:
				[agent_vel, agent_pos, goal_pos, goal_occupied] TODO: Description old
		"""
		...
		# # print("fairness_param",np.concatenate((agent.state.p_vel, agent.state.p_pos, goal_pos,goal_occupied,goal_history,tanh_output)))
		# # print(np.concatenate((agent.state.p_vel, agent.state.p_pos, goal_pos,goal_occupied,goal_history, rel_second_closest_goal,second_closest_goal_occupied,tanh_output) ))# + goal_occupied+ goal_history)
