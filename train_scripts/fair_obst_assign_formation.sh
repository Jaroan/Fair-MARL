...
--experiment_name "${str_dynamics_type}_fafr_nowalls_formation_nocollab_1Fair_30goal_5mil" \
...
&> $logs_folder/${str_dynamics_type}_fairassign_fairrew_nowalls_GoalMatch_GPU_1Fair_30goal_5mil_${seeds[$SLURM_ARRAY_TASK_ID]}
